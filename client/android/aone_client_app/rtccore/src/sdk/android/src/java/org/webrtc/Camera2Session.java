...
class Camera2Session implements CameraSession {
  ...
  private void findCaptureFormat() {
    ...
    Logging.d(TAG, "kimi... seting framerate: " + framerate); // kimi..
...
//    final CaptureFormat.FramerateRange bestFpsRange = new CaptureFormat.FramerateRange(30000,30000);  // kimi... 테스트 code
