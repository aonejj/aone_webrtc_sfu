...
public class PeerConnectionFactory {
  ...
  public static void initialize(InitializationOptions options) {
    ...
    if (options.loggable != null) {
      Log.d(TAG, "SDP_TRACE initialize options.loggable != null options.loggableSeverity" + options.loggableSeverity);
      ...
      Log.d(TAG, "SDP_TRACE initialize options.loggable == null");
      Logging.d(TAG,
  ...
  //  Log.d(TAG, "SDP_TRACE PeerConnectionFactory::initialize Logging.enableLogToDebugOutput(Logging.Severity.LS_VERBOSE)");
...
//    nativeInitThreadManager();    // for multi instance now disable
  }
