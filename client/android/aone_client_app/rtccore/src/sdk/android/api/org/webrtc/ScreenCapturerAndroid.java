...
import androidx.annotation.Nullable;  // kimi replace android.support.xxx => androidx.xxx
...
//    Log.d(TAG, "startCapture+++ isDisposed "+ isDisposed );
    checkNotDisposed();

    this.width = width;
    this.height = height;

    Log.d(TAG, "startCapture mediaProjectionManager.getMediaProjection+++");
    mediaProjection = mediaProjectionManager.getMediaProjection(
        Activity.RESULT_OK, mediaProjectionPermissionResultData);

    Log.d(TAG, "startCapture mediaProjectionManager.registerCallback+++");
    // Let MediaProjection callback use the SurfaceTextureHelper thread.
    mediaProjection.registerCallback(mediaProjectionCallback, surfaceTextureHelper.getHandler());

    Log.d(TAG, "startCapture createVirtualDisplay+++");
    createVirtualDisplay();
    Log.d(TAG, "startCapture onCapturerStarted+++");
    capturerObserver.onCapturerStarted(true);
    Log.d(TAG, "startCapture startListening+++");
    surfaceTextureHelper.startListening(ScreenCapturerAndroid.this);

    Log.d(TAG, "startCapture startCapture---" );
  }
...
//    Log.d(TAG,"SDP_TRACE ScreenCapturerAndroid onFrame");
    numCapturedFrames++;
