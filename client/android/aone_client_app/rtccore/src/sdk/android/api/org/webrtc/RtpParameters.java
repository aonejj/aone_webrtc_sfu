...
public class RtpParameters {
  ...
  public static class Encoding {
    ...
    public Encoding(String rid, boolean active, Double scaleResolutionDownBy) {
      ...
      Log.d("XXXX", "XXXX Encoding rid "+ rid + " active "+active + " scaleResolutionDownBy "+scaleResolutionDownBy); // add kimi
    }
    ...
    Encoding(String rid, boolean active, double bitratePriority, @Priority int networkPriority,
      ...
      this.scaleResolutionDownBy = scaleResolutionDownBy;
      this.ssrc = ssrc;
      Log.d("XXXX", "XXXX native Encoding rid "+ rid + " active "+active + " scaleResolutionDownBy "+scaleResolutionDownBy + " maxbit "+ maxBitrateBps + " ssrc " + ssrc); // add kimi
    }
